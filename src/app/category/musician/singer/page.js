...
export default function SingerPage() {
  ...
  const musicians = [
    {
      name: 'Jake Zyrus',
      description: 'formerly known as Charice Pempengco. Renowed singer and grammy award winner',
      image: '/jimi.jpg', 
      rating: 5,
      link: '/musician/guitarist/jakezyrus'
    },
    {
      name: 'Arnel Pineda',
      description: ' Long time member of American Band Journey.',
      image: '/eric.jpg', 
      rating: 4,
      link: '/musician/guitarist/pinedaarnel'
    },
