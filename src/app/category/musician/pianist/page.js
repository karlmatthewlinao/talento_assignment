...
export default function PianistPage() {
  ...
  const musicians = [
    {
      ...
      description: 'A legendary pianist known for his electrifying performances.',
      image: '/jimi.jpg', // Replace with actual image paths
      rating: 5,
      link: '/musician/guitarist/beethoven'
    },
    {
      name: 'Glenn Gould',
      description: 'Master Pianist, and Very Famous.',
      image: '/eric.jpg', // Replace with actual image paths
      rating: 4,
      link: '/musician/guitarist/gould'
    },
