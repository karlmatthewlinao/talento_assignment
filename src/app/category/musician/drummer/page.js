...
export default function DrummerPage() {
  ...
  const musicians = [
    {
      name: 'Ringo Star',
      description: 'Ringo Star a member of Beetles.',
      image: '/jimi.jpg', // Replace with actual image paths
      rating: 5,
      link: '/musician/guitarist/ringo'
    },
    {
      name: 'Nick Mason',
      description: ' English drummer and a founder member of the progressive rock band Pink Floyd.',
      image: '/eric.jpg', // Replace with actual image paths
      rating: 4,
      link: '/musician/guitarist/mason'
    },
