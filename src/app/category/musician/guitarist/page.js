...
export default function MusicianGuitaristPage() {
  ...
  const musicians = [
    {
      name: 'Jimi Hendrix',
      description: 'A legendary guitarist known for his electrifying performances.',
      image: '/jimi.jpg', // Replace with actual image paths
      rating: 5,
      link: '/musician/guitarist/jimihendrix'
    },
    {
      name: 'Eric Clapton',
      description: 'A master of blues guitar with a career spanning decades.',
      image: '/eric.jpg', // Replace with actual image paths
      rating: 4,
      link: '/musician/guitarist/ericclapton'
    },
