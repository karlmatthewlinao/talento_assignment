...
export default function ViolinistPage() {
  ...
  const musicians = [
    {
      name: 'Joshua Bell',
      description: 'music director of the Academy of St Martin in the Fields.',
      image: '/jimi.jpg', 
      rating: 5,
      link: '/musician/guitarist/bell'
    },
    {
      name: 'Hilary Hahn',
      description: ' A three-time Grammy Award winner, she has performed throughout the world as a soloist with leading orchestras and conductors.',
      image: '/eric.jpg', 
      rating: 4,
      link: '/musician/guitarist/hahn'
    },
