    ...
    >
      ...
      <div className="container mx-auto px-4 py-12 mt-16">
        <div className="bg-black text-white p-6 rounded-lg shadow-lg flex flex-col items-center">
          ...
          />
          <h1 className="text-3xl font-bold">Shaquille Oneal</h1>
          <p className="text-gray-300 mb-4">Basketball Superstar, Nba Greatest 75, 4-time Nba Champion, 1 time MVP, Has interest in ballet dancing</p>
